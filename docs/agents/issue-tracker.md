...
- **Blocking**: use GitHub native issue dependencies, falling back to a `Blocked by: #<n>` line.
- **Frontier query**: select the first unassigned open child without an open blocker.
